<?php
    ...
    class clsManagement{
        ...
        */
        ...
        public function Create_Admin_Administrator_Add(){
        ...
        public function Pre_Admin_Add_Administrator(){
			if(isset($_POST['Submit'])){
              ...
              if(isset($_POST['domainsID'])){
                foreach($_POST['domainsID'] as $key=>$val){
                    $this->db->RawQuery("INSERT INTO administrators_domains (administratorsID,domainsID) VALUES ($NewID,$val)");
                  }
              }
              ...
              if(isset($_POST['modulesID'])){
                if(is_array($_POST['modulesID'])){clsText
                  foreach($_POST['modulesID'] as $moduleID){
                    $this->db->RawQuery("INSERT INTO domains_modules (domainsID,modulesID) VALUES ($NewID,$moduleID)");
                  }
                }
              }
        ...
        public function Pre_Admin_Edit_Domain(){
            /*
			$id=false;
            ...
            //---get domain that is currently being edited--------------------------------------------------------------------------";
                ...
                $m->Set_Database($r);
                        ...
                        $this->db->RawQuery("DELETE FROM domains_modules WHERE domainsID=$id");
                        if(isset($_POST['modulesID'])){
                            if(is_array($_POST['modulesID'])){
                                foreach($_POST['modulesID'] as $moduleID){
                                    $this->db->RawQuery("INSERT INTO domains_modules (domainsID,modulesID) VALUES ($id,$moduleID)");
                                }
                            }
                        }
            ...
            //$Domain_Name=$this->app_data['remote_server']['domain_name'];
            //$this->db->Initialise_Remote_Server(true);
            $this->db->AddTable("domains");
                $this->db->AddSearchVar($id);
                $Insert=$this->db->GetRecord();
            //print_r($Insert);
                $ModsArr=array();
                $rslt=$this->db->RawQuery("SELECT modulesID FROM domains_modules WHERE domainsID=$id");
        ...
        public function Pre_Admin_Modify_Domain(){
            /*
            ...
            if(is_array($delete_id_array)){
                ...
                if($this->db->NumRows()>0){
                    //print "$$101-".$data."--".$sql."--\n";
                    $data=$this->db->Fetch_Assoc();
                    //print "\n$$171-".var_export($data,true)."--".$this->db->current_link."--\n";
                    //print_r($data);
                    ...
                    //$this->db->Set_Current_Server($delete_domain_data['Host']);
                    /*
                    print_r($this->app_data['delete_domain']);
                    ...
                    //print "\n$$88888-no home domain found->".$val."--".$sql."--".$this->db->current_link."---\n";
                }
                ...
                $rslt=$this->db->rawQuery($this->app_data['domains_populate']['search_sql']);
                if($this->db->NumRows()>0){
        ...
        public function Admin_Add_Member(){
            ...
            $this->output=$this->cls->clsHTMLContent->create_add_member_form_fields();
            return $this->output;
			...
			if(isset($_POST['Submit'])){
               ...
               // echo"690-----------------------------------------------------------".var_export($r,true)."------------------";
                ...
                if(isset($_POST['subdomain'])){
                    $subdomain=$this->db->Escape($_POST['subdomain']);
                }else{
                  $subdomain="";
                }
                ...
                if(isset($_POST['contact_name'])){
                    $contact_name=$this->db->Escape($_POST['contact_name']);
                }else{
                    $contact_name="";
                }
                ...
                if(isset($_POST['suburb'])){
                  $suburb=$this->db->Escape($_POST['suburb']);
                }else{
                    $suburb="";
                }
                ...
                if(isset($_POST['website'])){
                  $website=$this->db->Escape($_POST['website']);
                }else{
                    $website="";
                }
                ...
                if(isset($_POST['accesslvl'])){
                    $accesslvl=$this->db->Escape($_POST['accesslvl']);
                }else{
                    $accesslvl="";
                }
                if(isset($_POST['abn'])){
                  $abn=$this->db->Escape($_POST['abn']);
                }else{
                    $abn="";
                }
                if(isset($_POST['mod_business_categoriesID'])){
                  $mod_business_categoriesID=$this->db->Escape($_POST['mod_business_categoriesID']);
                }else{
                    $mod_business_categoriesID="";
                }
                if(isset($_POST['business_description'])){
                    $business_description=$this->db->Escape($_POST['business_description']);
                }else{
        ...
        public function Pre_Admin_Modify_Member(){
            /*
			if(isset($_GET['Delete'])){
              ...
              $rset=$this->db->rawQuery($SQL1);
              
                $rdata=$this->db->Fetch_Array($rset);
              ...
              $SQL3.=$sql_domains2." $SearchSQL  ORDER BY $OType $OOType LIMIT $StartRecord,$RecordsPerPage";
                $rset=$this->db->rawQuery($SQL2);
              
              $SQL_table=$SQL2;
              //print $SQL2."\n\n<br>";
              $nrows=$this->db->NumRows();
              if($nrows<1){
                $rset=$this->db->rawQuery($SQL3);
                $nrows=$this->db->NumRows();
                $rcount=$nrows;
                if($nrows<1){
                  $rcount=0;
        ...
        public function Pre_Admin_Modify_Administrators(){
            /*
			if(isset($_POST['Delete'])){
                if($_POST['Delete']=="Delete"){
                    if(is_array($_POST['DFiles'])){
        ...
        public function Pre_Admin_Edit_Administrators(){
            /*
			if(isset($_POST['Submit'])){
                if($_POST['Submit']){
                  $m= new UpdateDatabase($log);
                  ...
                  $this->db->RawQuery("DELETE FROM administrators_domains WHERE administratorsID=$_POST[id]");
                  if(isset($_POST['domainsID'])){
                      foreach($_POST['domainsID'] as $key=>$val){
                        $this->db->RawQuery("INSERT INTO administrators_domains (administratorsID,domainsID) VALUES ($_POST[id],$val)");
                      }
                  }
            ...
            $this->db->AddTable("administrators");
            $this->db->AddSearchVar($id);
            $Insert=$this->db->GetRecord();
            $DomArr=array();
        ...
        public function Pre_Admin_Add_Sub_Domain(){
            /*
			//-----------------------------------------------------------------------------------------------------------	
        ...
        function Pre_Admin_Set_Password(){
			if(isset($_POST['Submit'])){
                if($_POST['Submit']){
                    $this->db->AddTable("administrators");
                    $this->db->AddSearchVar($session_data['administratorsID']);
                    $Insert=$this->db->GetRecord();
        ...
        */
        public function Pre_Admin_Register(){
            $output="";
			if(isset($_GET['Message']))$Message=$_GET['Message'];
                ...
                if(isset($_POST['Submit'])){
                    ...
                    //print_r($_POST);
                    $rslt=$this->db->RawQuery($sql); 
                    $AdministratorsID=$this->db->Insert_Id();
                    //echo"10-----------------------------------------------------------".var_export($r,true)."------------------";
                    if($_POST['subdomain']==""){
        ...
        public function Pre_Admin_Add_Page(){
			if(isset($_POST['Submit'])){
                if($_POST['Submit']){
                    /*
                    ...
                    if($_POST['HomePage']=="Yes"){
                        $this->db->RawQuery("UPDATE content_pages SET HomePage='No' WHERE domainsID=".$this->app_data['domainsID']." AND languagesID=".$this->app_data['languagesID']);
                    }
                    // check if no homepage
                    $rslt=$this->db->RawQuery("SELECT COUNT(*) FROM content_pages WHERE domainsID=".$this->app_data['domainsID']." AND languagesID=".$this->app_data['languagesID']);
                    $data=$this->db->Fetch_Array($rslt);
              ...
              /* removed 2023-03-19
                    if($_POST['sidebar_module_viewsID']==11){
                        $_POST['content_text_sidebar']=$this->db->Escape($_POST['content_text_sidebar']);
                        $this->db->RawQuery("INSERT INTO mod_text (content_pagesID,content_text,sidebar_content) VALUES ($NewID,'$_POST[content_text_sidebar]','Yes')");
                    }
                    removed 2023-03-19 *//*
                    $Message="Page Added";
                    */
            ...
            //$this->db->AddTable("domains");
           // $this->db->AddSearchVar($this->app_data['domainsID']);
            //$DInsert=$this->db->GetRecord();
		}

        public function Pre_Admin_Modify_Page(){
            /*
			if(isset($_POST['Delete'])){
                if($_POST['Delete']=="Delete"){
                    if(is_array($_POST['DFiles'])){
                $this->db->Set_Current_Server($this->app_data['remote_server']['domain_name']);
        ...
        public function Pre_Admin_Edit_Page(){
            /*
			$this->db->Set_Current_Server($this->app_data['remote_server']['domain_name']);
            if(isset($_POST['Submit'])){
                if($_POST['Submit']){
                    if($_POST['HomePage']=="Yes"){
                        $this->db->RawQuery("UPDATE content_pages SET HomePage='No' WHERE languagesID=$session_data[languagesID] AND domainsID=$session_data[domainsID]");
                    }
                    $_POST['URI']=dirify($_POST['URI']);// remove reserved characters
                    if(substr($_POST['URI'],0,1)!="/") $_POST['URI']="/".$_POST['URI']; // if start of string not /
                    if(substr($_POST['URI'],strlen($_POST['URI'])-1,1)!="/") $_POST['URI']=$_POST['URI']."/";// if end of string not /
            ...
            $m->Set_Database($r);
                    ...
                    $_POST['content_text']=$this->db->Escape($_POST['content_text']);
                    $this->db->RawQuery("UPDATE mod_text SET content_text='$_POST[content_text]' WHERE content_pagesID=$_POST[id] AND sidebar_content='No'");
                    //change sidebar text content
            /* removed 2023-03-19
                    if($_POST['sidebar_module_viewsID']==11){
                        $rslt=$this->db->RawQuery("SELECT COUNT(*) FROM mod_text WHERE content_pagesID=$_POST[id] AND sidebar_content='Yes'");
                        if($rslt){
                            $_POST['content_text_sidebar']=$this->db->Escape($_POST['content_text_sidebar']);
                            $data=$this->db->Fetch_Array();
                            if($data[0]>0){
                                $this->db->RawQuery("UPDATE mod_text SET content_text='$_POST[content_text_sidebar]' WHERE content_pagesID=$_POST[id] AND sidebar_content='Yes'");//echo "xx";
                            }else{
                                $this->db->RawQuery("INSERT INTO mod_text (content_pagesID,content_text,sidebar_content) VALUES ($_POST[id],'$_POST[content_text_sidebar]','Yes')");//echo "yy";
                            }
                        }else{
                            //echo "zz";	
                        }
            ...
            $this->db->AddTable("content_pages");
            $this->db->AddSearchVar($id);
        //echo"=>2 add search var=>".var_export($_POST,true)."<=\n\n";
            $Insert=$this->db->GetRecord();
            $this->db->AddTable("mod_text");
            $this->db->AddSearchVar($id);
            $this->db->AddNewSearchVar("sidebar_content","No");
            $this->db->ChangeTarget("content_pagesID");
            $TInsert=$this->db->GetRecord();
        //print_r($TInsert);
        ...
        if(isset($Insert['sidebar_module_viewsID'])){
            ...
            $this->db->AddTable("mod_text");
            $this->db->AddSearchVar($id);
            //$this->db->AddNewSearchVar("sidebar_content","Yes");
            $this->db->AddNewSearchVar("sidebar_content","No");
            $this->db->ChangeTarget("content_pagesID");
            $TSInsert=$this->db->GetRecord();
        ...
        */
        ...
        public function Pre_Admin_Login(){
            /*
			if(isset($_GET['file'])){
                $file_name=$_GET['file'];
            ...
            */  
            ...
            if(isset($_POST['Submit'])){
                if($_POST['Submit']!=""){
                    ...
                    $data=$this->db->rawQuery($sql);
                    $login_array=$this->db->Fetch_Array($data);
            ...
            if($login){
                ...
                $dataarray=$this->db->Fetch_Array($data);
                //print_r($dataarray);
                /*
        ...
        public function Pre_Admin_Edit_Member(){
			
		}

        public function Pre_Admin_Add_News(){
			
		}

        public function Pre_Admin_Modify_News(){
			
		}

        public function Pre_Admin_Edit_News(){
			
		}

        public function Pre_Admin_Add_Links(){
			
		}

        public function Pre_Admin_Modify_Links(){
			
		}

        public function Pre_Admin_Edit_Links(){
			
		}

        public function Pre_Admin_Add_Testimonials(){
			
		}

        public function Pre_Admin_Modify_Testimonials(){
			
		}

        public function Pre_Admin_Edit_Testimonials(){
			
		}

        public function Pre_Admin_Add_Gallery(){
			
		}

        public function Pre_Admin_Modify_Gallery(){
			
		}

        public function Pre_Admin_Edit_Gallery(){
			
		}

        
        
        public function Create_Country_Select($countryID=0){
            $output="";
        ...
        public function Create_Business_Categories_Select($domainsID=0,$mod_business_categoriesID=0){
            $output="";
            $output='<SELECT NAME="mod_business_categoriesID" id="mod_business_categoriesID">';
            
            $sql=$this->db->rawQuery("SELECT id,CategoryTitle FROM mod_business_categories WHERE domainsID=".$domainsID." OR domainsID=0 ORDER BY CategoryTitle");
            while($myrow=$this->db->Fetch_Array($sql)){
        ...
        public function Admin_Add_Domain(){
            //echo"hh";
            $this->output=__METHOD__;
            $this->output=$this->cls->clsHTMLContent->create_add_domain_form_fields();
            return $this->output;
        }
        ...
        public function Domain_Add_New(){
            $this->output=__METHOD__;
            $this->output="XXX";
            $this->output=$this->cls->clsHTMLContent->create_add_domain_form_fields();
            return $this->output;
