<?php
    ...
    class clsICustomLanguage{
        ...
        private function set_token_codes() {
            ...
            $alias[0][8]="alias_variable_prefix";

            $alias_variables=$alias[0][4];
            $alias_operators=$alias[0][5];
            $alias_variable_types=$alias[0][6];
            $alias_variable_prefix=$alias[0][8];
            ...
            $alias[$alias[0][1]][16]="Menu_Item_Number";
			...
			$alias[$alias[0][3]][0]="tag";
            $alias[$alias[0][3]][1]="alias";
            $alias[$alias[0][3]][2]="return";
            $alias[$alias[0][3]][3]="variable"; // "multiple"
            $alias[$alias[0][3]][4]="next_command";
            $alias[$alias[0][3]][5]="start_commands";
            $alias[$alias[0][3]][6]="sub_commands";
            $alias[$alias[0][3]][7]="previous_command_level";
            $alias[$alias[0][3]][8]="end";
            $alias[$alias[0][3]][9]="if";// "equate" | "multiple" | "variable" | "input" | "alias_type" | "alias_properties" | "line_number"
            $alias[$alias[0][3]][10]="then";
            $alias[$alias[0][3]][11]="else";
            $alias[$alias[0][3]][12]="equate";
            $alias[$alias[0][3]][13]="input";
            $alias[$alias[0][3]][14]="multiple";
            $alias[$alias[0][3]][15]="end";
            $alias[$alias[0][3]][16]="target"; // "line_number" | "input" | 
            $alias[$alias[0][3]][17]="set";
            $alias[$alias[0][3]][18]="name";
            $alias[$alias[0][3]][19]="line_number";
            $alias[$alias[0][3]][20]="self";
            $alias[$alias[0][3]][21]="create";
            $alias[$alias[0][3]][21]="alias_type";
            $alias[$alias[0][3]][21]="processor_pipe";
            $alias[$alias[0][3]][21]="convert";
            $alias[$alias[0][3]][21]="array";
            $alias[$alias[0][3]][21]="where";
            $alias[$alias[0][3]][21]="for";
            $alias[$alias[0][3]][21]="sort";
            $alias[$alias[0][3]][21]="requires";
            $alias[$alias[0][3]][21]="optional";
            $alias[$alias[0][3]][21]="match";
            $alias[$alias[0][3]][21]="none";
            $alias[$alias[0][3]][21]="include";
            $alias[$alias[0][3]][21]="default";
            $alias[$alias[0][3]][21]="output";
            
            $alias[$alias_variables][0]="create | function | main | return";
            ...
            $alias[$alias_variable_types][5]="array";
            $alias[$alias_variable_types][5]="boolean";
            $alias[$alias_variable_types][5]="char";
            $alias[$alias_variable_types][5]="integer";
            $alias[$alias_variable_types][6]="string";
            $alias[$alias_variable_types][7]="decimal";
            $alias[$alias_variable_types][7]="temp";
            $alias[$alias_variable_types][7]="function";
            $alias[$alias_variable_types][7]="class";
            $alias[$alias_variable_types][7]="static";
            $alias[$alias_variable_types][7]="interface";
            $alias[$alias_variable_types][7]="pipe";
            $alias[$alias_variable_types][5]="public";
            $alias[$alias_variable_types][5]="private";
            $alias[$alias_variable_types][5]="constructor";
            $alias[$alias_variable_types][5]="destructor";
            $alias[$alias_variable_types][5]="ascending";
            $alias[$alias_variable_types][5]="descending";
            $alias[$alias_variable_types][5]="byref";
            $alias[$alias_variable_types][5]="byval";
            $alias[$alias_variable_types][5]="event";
            $alias[$alias_variable_types][5]="length";

            $alias[$alias_variable_prefix][0]="cls";
            $alias[$alias_variable_prefix][1]="fnc";
            $alias[$alias_variable_prefix][2]="int";
            $alias[$alias_variable_prefix][3]="bl";
            $alias[$alias_variable_prefix][4]="chr";
            $alias[$alias_variable_prefix][5]="str";
            $alias[$alias_variable_prefix][6]="dec";
            $alias[$alias_variable_prefix][7]="stc";
            $alias[$alias_variable_prefix][8]="cls";

            $alias[$alias_variable_prefix][0]="item";
            $alias[$alias_variable_prefix][1]="expression";
            $alias[$alias_variable_prefix][2]="numeric";
            $alias[$alias_variable_prefix][3]="properties";
            $alias[$alias_variable_prefix][4]="variables";
            $alias[$alias_variable_prefix][5]="conditional";
            $alias[$alias_variable_prefix][6]="mathmatical";
            $alias[$alias_variable_prefix][7]="command";
            $alias[$alias_variable_prefix][8]="IO"; // input | output
            $alias[$alias_variable_prefix][8]="processor"; // input | output
            $alias[$alias_variable_prefix][8]="pipe"; // input | output
            $alias[$alias_variable_prefix][8]="description"; // input | output
            $alias[$alias_variable_prefix][8]="type"; // input | output
            $alias[$alias_variable_prefix][8]="definition"; // input | output
            $alias[$alias_variable_prefix][8]="IO"; // input | output
            $alias[$alias_variable_prefix][8]="IO"; // input | output
            ...
            $alias[$alias[0][3]][0]="alias_expression_types";
            $alias[$alias[0][3]][1]="alias_item_numbers";
            $alias[$alias[0][3]][2]="alias_properties_item_target_numbers";
            $alias[$alias[0][3]]["="]="alias_properties_item_numbers";
